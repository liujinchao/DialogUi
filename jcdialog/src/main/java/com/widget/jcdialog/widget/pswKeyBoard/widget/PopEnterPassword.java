package com.widget.jcdialog.widget.pswKeyBoard.widget;
...
/**
 * 类名称：PopEnterPassword
 * 创建者：Create by liujc
 * 创建时间：Create on 2017/3/20 16:31
 * 描述：输入支付密码
 */
public class PopEnterPassword extends PopupWindow {
    ...
    public PopEnterPassword(final Activity context) {
        ...
        mMenuView = inflater.inflate(R.layout.psw_pop_enter_pay_password, null);
...
//        });
        ...
        this.setAnimationStyle(R.style.bottom_menu_windown_animstyle);
