...
import com.widget.jcdialog.widget.pswKeyBoard.adapter.KeyBoardAdapter;
 ...
 * 类名称：PasswordView
 * 创建者：Create by liujc
 * 创建时间：Create on 2017/3/20 16:32
 * 描述：弹框里面的View
 */
public class PasswordView extends RelativeLayout {
    ...
    public PasswordView(Context context, AttributeSet attrs) {
        ...
        View view = View.inflate(context, R.layout.psw_keyboard_layout_popup_bottom, null);
