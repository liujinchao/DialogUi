...
//        }
    ...
    public void setProgressStyle(int style,int indicatorColor) {
//        if(style == ProgressStyle.SysProgress){
//            mProgressBar.setView(new ProgressBar(getContext(), null, android.R.attr.progressBarStyle));
//        }else{
        LoadingIndicatorView progressView = new LoadingIndicatorView(this.getContext());
...
//        }
    ...
    public void setHeaderRefreshTime(long refreshTime){
        mHeaderTimeView.setText(friendlyTime(refreshTime));
    }
    ...
    public void refreshComplete(){
        mHeaderTimeView.setText(friendlyTime(System.currentTimeMillis()));
        setState(STATE_DONE);
