...
import com.widget.jcdialog.holder.AlertDialogHolder;
import com.widget.jcdialog.holder.SheetHolder;
...
public class Buildable {
    ...
    protected BuildBean buildByType(BuildBean bean) {
        ...
        switch (bean.type) {
            ...
            case CommonConfig.TYPE_BOTTOM_SHEET:
                ...
                break;
            case CommonConfig.TYPE_TIMEPICK:
                buildTimeDialog(bean);
                break;
            default:
                break;
    ...
    private void buildTimeDialog(BuildBean bean) {
        BottomDialog dialog = new BottomDialog(bean.mContext);
        dialog.setOnAddressSelectedListener(bean.addressListener);
        bean.dialog = dialog;
    }
